...
When deploying on Heroku, be sure that both python and node.js buildpack are initialized. In the Heroki CLI, just run `heroku buildpacks:add heroku/python`to set up python.
