...
With `pip3 show <packageneame>` you can see the details of a package.
...
Runninn the following command 'npm run deploy' will trigger the deployment of the master branch.
